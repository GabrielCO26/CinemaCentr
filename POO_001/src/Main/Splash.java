...
public class Splash extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Fondo2 = new GUIresources.RoundPanel();
        ...
        Fondo1.setColor(new java.awt.Color(57, 0, 165));
        Fondo1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Fondo2.setColor(new java.awt.Color(75, 0, 216));
        Fondo2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Exit_Panel.setBackground(new java.awt.Color(75, 0, 216));
        ...
        Fondo2.add(Exit_Panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, 30, 30));

        VEGA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/VEGA 70x25.png"))); // NOI18N
        Fondo2.add(VEGA, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, -1, 33));

        Imagotipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Imagotipo 300x203.png"))); // NOI18N
        Fondo2.add(Imagotipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, 300, 210));

        Estado.setFont(new java.awt.Font("Roboto Medium", 0, 22)); // NOI18N
        Estado.setForeground(new java.awt.Color(255, 255, 255));
        Estado.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        Estado.setText("Referencia");
        Fondo2.add(Estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 270, 30));

        Fondo1.add(Fondo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 430, 280));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Fondo1, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(Fondo1, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private GUIresources.RoundPanel Fondo2;
