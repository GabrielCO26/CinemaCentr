...
public class CrearCine extends javax.swing.JFrame {
    ...
    public CrearCine(Main.User user) {
        ...
        /*
        newUserLabel.setText("Bienvenido " + loggedInUser.getUsername());
        int panelWidth = Bg.getWidth();
        int panelHeight = Bg.getHeight();

        Dimension labelSize = newUserLabel.getPreferredSize();
        int labelWidth = labelSize.width;
        int labelHeight = labelSize.height;
        int labelX = (panelWidth - labelWidth) / 2;

        newUserLabel.setBounds(labelX, 0, labelWidth, labelHeight);
        StartButton.setBounds(470, 326, StartButton.getWidth(), StartButton.getHeight());
        roundPanel21.setBounds(192, 56, roundPanel21.getWidth(), roundPanel21.getHeight());
        newUserLabel1.setBounds(220, 290, newUserLabel1.getWidth(), newUserLabel1.getHeight());
        CineField.setBounds(190, 326, CineField.getWidth(), CineField.getHeight());

        Bg.add(newUserLabel);
        Bg.add(StartButton);
        Bg.add(roundPanel21);
        Bg.add(newUserLabel1);
        Bg.add(CineField);
         */
        
        System.out.println("---------------------");
        System.out.println("From CrearCine");
